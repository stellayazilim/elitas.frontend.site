<script lang="ts">
	...
	function validateForm() {
		//Submit tıklandığı zaman input alanlarının doğru girildiğini client tarafında kontrol eder başka işlevi yok
	...
	function handleSubmit(event: { preventDefault: () => void }) {
		//input alanları doğru ise çalışacak kısım
		...
		>
			...
			<div class="control-group">
				<input
					...
					class:is-valid={isValid.emailIsNull && isValid.emailIsValid}
					class:is-invalid={!isValid.emailIsValid || !isValid.emailIsNull}
					bind:value={email}
					required={true}
				/>
			...
			<div class="control-group">
				<input
					...
					class:is-invalid={!isValid.subject}
					bind:value={subject}
					required={true}
				/>
			...
			<div class="control-group">
				<textarea
					...
					class:is-invalid={!isValid.message}
					bind:value={message}
					required={true}
				/>
